  ...
  const discoverCards = [
    {
      id: 1,
      image:
        "https://cloudinary.pondigital.solutions/urbanarrow/images/c_scale,w_648,h_967/ar_16:9,c_fill/w_auto,c_fill/f_auto,q_auto/v1723554357/NEW%20website/Roadshow%20-%20WEB/DSCF9773/DSCF9773.jpg?_i=AA",
      title: "Bike Advisor",
      description:
        "With the bike advisor, you will discover which bike suits you in one time",
      buttonText: "Bike Advisor",
    },
    {
      id: 2,
      image:
        "https://cloudinary.pondigital.solutions/urbanarrow/images/c_scale,w_648,h_967/ar_16:9,c_fill/w_auto,c_fill/f_auto,q_auto/v1716367044/NEW%20website/Shoot%20US%202023%20-%20WEB/DSC_2659/DSC_2659.jpg?_i=AA",
      title: "Cargo bike pocket guide",
      description:
        "Take your favorite bike on the road and see how it fits your lifestyle.",
      buttonText: "Read",
    },
    {
      id: 3,
      image:
        "https://cloudinary.pondigital.solutions/urbanarrow/images/c_scale,w_648,h_432/ar_16:9,c_fill/w_auto,c_fill/f_auto,q_auto/v1690363308/NEW%20website/Shoot%20US%202023%20-%20WEB/_DSC0771-web/_DSC0771-web.jpg?_i=AA",
      title: "Service Center",
      description:
        "Learn how to keep your bike in top shape with expert advice.",
    ...
    <div className="pt-6 pb-32">
      <div className="xl:max-w-[86%] text-[#000] mx-auto pt-16 md:pt-20   max-w-[72rem] px-6">
        <div className="flex items-center justify-between gap-2">
          <h1 className="text-[7vw] md:text-[45px] xl:text-[63px]  leading-none ">
            More to discover
          </h1>
          <div className="md:flex hidden items-center gap-1.5">
            ...
            <div
              onClick={customNext}
              className={`size-10 transition-opacity duration-300 ease-in-out ${
                isEnd
                  ? "opacity-30 cursor-not-allowed"
                  : "opacity-90 cursor-pointer hover:bg-black hover:scale-[1.05]"
              } bg-[#1A1919] rounded-full z-[4] relative flex text-white transition-all duration-100 items-center justify-center`}
        ...
        <div className="mt-14 flex justify-between md:justify-end"></div>
      </div>
