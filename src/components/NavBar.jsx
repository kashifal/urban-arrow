              ...
              <div className="relative text-white z-[9999] md:hidden block">
                ...
                >
                  <div className="flex flex-col items-start space-y-4">
                    ...
                    {/* Language Selection */}
                    <div className="flex w-full border border-[#646363] rounded-full justify-center px-[10px] py-[2px] mt-[6px]" onClick={() => handleLanguageChange('es')}>
                      <p className="text-[14px]">Español</p>
                      <img src={asset9} className="h-[18px] ml-[6px] mt-[2px]" alt="" />
                    </div>
                    <div className="flex w-full border border-[#646363] rounded-full justify-center px-[10px] py-[2px] mt-[6px]" onClick={() => handleLanguageChange('fr')}>
                      <p className="text-[14px]">Français</p>
                      <img src={asset9} className="h-[18px] filter ml-[6px] mt-[2px]" alt="" />
                    </div>
                    <div className="flex w-full border border-[#646363] rounded-full justify-center px-[10px] py-[2px] mt-[6px]" onClick={() => handleLanguageChange('en')}>
