      ...
      <div className='2xl:min-h-[50vw] min-h-[60vw] text-[#1A1919] bg-[#FAFAF0] mt-6 grid sm:grid-cols-2 2xl:h-full'>
        ...
        <Animate time={0.2}>
          ...
          <div className="flex flex-wrap items-center gap-1.5 mt-5">
            <button className="bg-[#BEEB82]  button-font px-5 hover:bg-[#a2c86f] py-3.5 rounded-full text-black font-medium">Find your dealer</button>
            <button className="bg-[#FF8C3C]  button-font px-5 hover:bg-[#e78741] py-3.5 rounded-full text-black font-medium">Configure your bike</button>
          </div>
          </Animate>
        </div>
      </div>
