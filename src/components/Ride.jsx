...
const Ride = () => {
  return (
    <div className='2xl:min-h-[50vw] min-h-[60vw] text-[#1A1919] bg-[#FAFAF0] mt-6 grid md:grid-cols-2 2xl:h-full'>
        <img src={SmothRide} className='w-full h-[40vh] md:h-full object-cover ' alt="" />
        <div className="xl:w-[70%] py-20 md:py-10 w-[95%] md:w-[90%] mx-auto h-full flex flex-col justify-center px-6">
    <h1 className="text-[7vw] md:text-[4.9vw] xl:text-[65px]  leading-none ">The smoothest ride</h1>
