    ...
    <div className="md:col-span-5 px-4 text-white h-full flex py-14 bg-[#121417]">
      <div className="max-w-[350px] flex flex-col justify-between w-full mx-auto">
        <div className="">
          ...
          <h1 className="font-normal pt-6">{t('dogwiftools_license')}</h1> {/* Translated text */}
          <h1 className="font-normal pt-1 text-lg pb-6">{t('price')}</h1> {/* Translated text */}
          ...
          <div className="mt- w-full">
            <div className="flex items-start justify-between">
              <div className="flex items-start gap-2">
                ...
                <div className="">
                  <h1 className="font-light text-sm">{t('dogwiftools_license')}</h1> {/* Translated text */}
                  <h1 className="font-normal pt-[2px] text-[#777F89] text-xs">{t('quantity')}</h1> {/* Translated text */}
                </div>
              </div>
              <h1 className="font-light text-sm">{t('price')}</h1> {/* Translated text */}
            </div>
            <div className="flex items-start py-5 justify-between">
              ...
              <h1 className="font-medium text-sm">{t('price')}</h1> {/* Translated text */}
            </div>
