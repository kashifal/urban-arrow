...
const Integration = () => {
  return (
    <>
      <div className="relative w-full flex justify-center items-center">
        <div className=" h-screen w-full flex justify-center items-center">
          <div className="absolute flex justify-center items-center rounded-full">
            <div className="absolute w-64 h-64 rounded-full bg-white/5 backdrop-blur-3xl border border-white/5"></div>
            <div className="absolute w-52 h-52 rounded-full bg-white/5 backdrop-blur-3xl border border-white/5"></div>
          </div>
        ...
        <div className="absolute lg:block hidden top-[10%] xl:top-[20%] left-[50%] transform -translate-x-1/2 -translate-y-1/2">
          <div className="flex justify-center items-center w-20 h-20 bg-white/5 backdrop-blur-3xl rounded-full">
            <img src="../src/assets/circle1.avif" alt="Icon 1" className="" />
          </div>
        </div>
      ...
      <div className="-mt-20 max-w-[74rem] mx-auto lg:px-0 px-4  ">
