      ...
      <div className="sm:grid grid-cols-12 flex flex-col gap-8 pb-10 min-h-[50vh] text-white bg-[rgb(14,14,14)] px-[30px] pt-[30px] rounded-lg mt-[50px]">
        ...
        <div className="col-span-3 gap-8 md:flex-row flex-col flex items-start justify-between">
          <div className="text-[14px] xs:col-span-12 md:col-span-2">
            <p className="text-[#494848]">{t('footer_shop')}</p>
            <a href="#" className="block mt-[10px]">{t('footer_products')}</a>
            <a href="#" className="block mt-[10px]">{t('footer_collections')}</a>
            <a href="#" className="block mt-[10px]">{t('footer_reviews')}</a>
          </div>
          <div className="text-[14px] xs:col-span-12 md:col-span-2">
            <p className="text-[#494848]">{t('footer_about')}</p>
            <a href="#" className="block mt-[10px]">{t('footer_contact')}</a>
            <a href="#" className="block mt-[10px]">{t('footer_terms')}</a>
          </div>
        </div>
      </div>
    </>
