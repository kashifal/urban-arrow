...
function HeroSection() {
  ...
  return (
    <div className="md:h-screen z-[4] min-h-screen sm:min-h-[60vh] w-screen relative">
      <video
      ...
      <div className=" z-[9999]  text-white top-[90%] sm:top-auto sm:bottom-20 absolute text-xl right-0 md:right-auto  md:left-[93%] transform  gap-2">
