  ...
  return (
    <div className="lg:h-screen overlflow-hidden z-[4] min-h-[120vh] md:min-h-[60vh] w-screen relative">
      ...
      <div className=" z-40 md:mt-6 w-[98%] sm:auto   lg:w-fit md:w-[70%] md:mx-auto md:mx-0 tracking-wide absolute top-[48%] sm:top-[50%] md:top-1/2 pl-6 sm:pl-10 md:pl-0 md:left-[8%] md:right-1/2 transform   md:-translate-y-1/2  ">
        <h1 className="md:text-[71.3px] xl:text-[5.6rem] text-5xl md:text-6xl text-white font- ">Meet your <br className="md:block hidden" /> next car</h1>
        ...
        <button id="myBtn" className="bg-[#BEEB82] font-medium button-font hover:opacity-90 sm:mt-7 px-5 py-3.5 rounded-full" onClick={handlePause}>
          Explore all bikes
        </button>
      </div>
