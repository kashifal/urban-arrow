      ...
      <section className="bg-black text-white  pb-[50px]">
        <div className="w-[80%] mx-auto pt-[50px]">
          <div className="bg-[rgb(14,14,14)] text-white pl-[50px] shadow-xl rounded-lg py-[30px]">
            <h1 className="text-[3rem] font-semibold">Terms and Conditions</h1>
            <p className="text-[#a19e9e]">
              Please review our terms and conditions carefully before using our
              website or services.
            </p>
          </div>
          <div className="bg-[rgb(14,14,14)] text-white px-[20px] mt-[50px] py-[10px] text-[12px] leading-[24px]">
            <p>TERMS OF SERVICE</p>
            <p className="font-thin">Last updated June 23, 2024</p>
            <p>1. AGREEMENT TO TERMS</p>
            <p className="font-thin leading-normal">
              These Terms of Use constitute a legally binding agreement made
              between you, whether personally or on behalf of an entity (“you”)
              and DogWifTools, doing business as ("DogWifTools," "we," “us”, or
              ...
              website or mobile application related, desktop website or desktop
              application related, linked, or otherwise connected thereto
              (collectively, the “Site”). DogWifTools operates in accordance
              with applicable laws and regulations. You agree that by accessing
            ...
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">2. INTELLECTUAL PROPERTY RIGHTS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">3. USER REPRESENTATIONS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">4. USER REGISTRATION</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">5. FEES AND PAYMENT</p>
            <p className="font-light leading-normal mt-[10px]">
              We accept the following form of payment:
            </p>
            <p className="mt-[10px]">Cryptocurrency</p>
            <p className="font-light leading-normal mt-[10px]">
              ...
              information, including email address and payment method, so that
              we can complete your transactions and contact you as needed. We
              ...
              payments shall be in cryptocurrency. You agree to pay all charges
            ...
            <p className="mt-[10px]">6. CANCELLATION</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">8. SOFTWARE</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">8. PROHIBITED ACTIVITIES</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">9. USER GENERATED CONTRIBUTIONS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">10. CONTRIBUTION LICENSE</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">11. GUIDELINES FOR REVIEWS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">12. SOCIAL MEDIA</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">13. SUBMISSIONS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">14. THIRD-PARTY WEBSITES AND CONTENT</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">15. U.S. GOVERNMENT RIGHTS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">16. SITE MANAGEMENT</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">17. TERM AND TERMINATION</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">18. MODIFICATIONS AND INTERRUPTIONS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">19. GOVERNING LAW</p>
            <p className="font-light leading-normal mt-[10px]">
              These Terms shall be governed by and defined following the laws
              applicable to decentralized digital platforms. The jurisdiction
              for resolving any disputes will be mutually agreed upon by the
              parties involved.
            </p>
            <p className="mt-[10px]">20. DISPUTE RESOLUTION</p>
            <p className="font-light leading-normal mt-[10px]">
              You agree to irrevocably submit all disputes related to these
              Terms or the legal relationship established by this Agreement to a
              mutually agreed-upon jurisdiction. DogWifTools reserves the right
              to bring proceedings in the courts of the country where you reside
              or, if these Terms are entered into in the course of your trade or
              profession, the state of your principal place of business.
            </p>
            <p className="mt-[10px]">21. CORRECTIONS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">22. DISCLAIMER</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">23. LIMITATIONS OF LIABILITY</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">24. INDEMNIFICATION</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">25. USER DATA</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">27. CALIFORNIA USERS AND RESIDENTS</p>
            <p className="font-light leading-normal mt-[10px]">
            ...
            <p className="mt-[10px]">28. MISCELLANEOUS</p>
            <p className="font-light leading-normal mt-[10px]">
              ...
              to execute these Terms of Use. Unauthorized copying, editing, and
              sharing of any file, via any medium is strictly prohibited.
            </p>
            <p className="mt-[10px]">29. CONTACT US</p>
            <p className="font-light leading-normal mt-[10px]">
