            ...
            <div className="mt-10 border-t border-b border-white/10 py-5">
              ...
              <div className="mt-4 flex flex-col gap-2">
                <div className="flex items-center justify-between gap-2">
                    <h4 className="text-[#737A84] font-light text-[13px] sm:text-sm">Total Price</h4>
                ...
                <div className="flex items-center justify-between gap-2">
                    <h4 className="text-[#737A84] font-light text-sm">Exchange Rate</h4>
                    <div className="flex items-center gap-1">
                ...
                <div className="flex items-center justify-between gap-2">
                    <h4 className="text-[#737A84] font-light text-[13px] sm:text-sm">Amount</h4>
                    <div className="flex items-center gap-1">
    ...
    <defs>
        <linearGradient id="paint0_linear_1221_31173" x1="18" y1="0" x2="18" y2="36" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stop-color="#B647F0"/>
                ...
                <div className="flex items-center justify-between gap-2">
                    <h4 className="text-[#737A84] font-light text-[13px] sm:text-sm">Created</h4>
                    <div className="flex items-center gap-1">
