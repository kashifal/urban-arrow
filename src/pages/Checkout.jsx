  ...
  return (
    <>
      <div className="bg-black text-white min-h-screen">
        ...
        <p className="py-3">{cartItems.length} item in your cart</p>
          ...
          <div className="p-5">
            <div className="relative w-full h-fit ">
                ...
                <input type="text" placeholder="Enter coupon code" className="py-2 w-full placeholder:text-sm text-sm pl-8 text-gray-400 focus:border-[#818CF8] outline-none border-white/5 border pr-4 bg-[#2A2B3F] rounded-lg" />
            ...
            <button className="bg-[#FF00C0] py-2.5 rounded-full w-full text-center font-medium mt-8">Continue</button>
            </Link>
          </div>
          </div>
          </div>
