...
const Product = () => {
 ...
 <div className="bg-black text-white  min-h-screen">
    <NavBar />
  <div className="max-w-[68rem] pt-8 py-b0 mx-auto lg:flex-col lg:justify-center lg:items-center">
  <div className="flex items-center pb-14 justify-between gap-3">
  ...
  <div className="relative w-fit bg-[#17161B] rounded-2xl shadow-md overflow-hidden">
    ...
    <defs>
      ...
      <div className="flex items-center pt-20 pb-14 justify-between gap-3">
  ...
  <div className="mb-40 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
  {cardsData.map((card) => (
        <Card
          key={card.id}
          date={card.date}
